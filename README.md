...
You need to change `crypto -> crypto-browserify` and `stream -> readable-stream` and `randombytes -> nativescript-randombytes`
manually in bundles for now. We should automate this process.
